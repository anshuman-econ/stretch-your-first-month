...
const aliasExplainers: Record<string, string> = {
  ...
  "pilates / barre seat": "A structured strength and mobility session, often off-peak or inventory-gated.",
  "pilates / barre intro": "A structured strength and mobility session, often off-peak or inventory-gated.",
  "mobility": "Movement and posture support for stiffness, recovery, pain, strength, or function.",
  "mobility / physio": "Movement and posture support for stiffness, recovery, pain, strength, or function.",
  "mobility micro-class": "Movement and posture support for stiffness, recovery, pain, strength, or function.",
  "breathwork / recovery": "A nervous-system and recovery option for sleep, stress, fatigue, or high-output weeks.",
  "breathwork reset": "A nervous-system and recovery option for sleep, stress, fatigue, or high-output weeks.",
  "breathwork": "A nervous-system and recovery option for sleep, stress, fatigue, or high-output weeks.",
  "strength + vo2 prep": "A strength and aerobic-base support session for energy, performance, and longevity.",
  "dermatology review": "A skin-focused review for acne, pigmentation, barrier issues, glow, and procedure planning.",
  "derm-led review": "A skin-focused review for acne, pigmentation, barrier issues, glow, and procedure planning.",
  "quick derm review": "A short skin review to confirm routine direction, actives, barrier support, or procedure readiness.",
  "derm-adjacent review": "A skin-focused review for acne, pigmentation, barrier issues, glow, and procedure planning.",
  "tricho review": "A hair and scalp review for shedding, thinning, density, scalp irritation, or regrowth planning.",
  "im / metabolic review": "A metabolic and internal-medicine review for fatigue, insulin resistance, thyroid, weight drift, or prevention markers.",
  "internal medicine review": "A medical review for fatigue, thyroid, metabolic, recovery, and prevention questions.",
  "longevity-oriented im review": "A physician review for focus, fatigue, recovery, biomarkers, and healthspan direction.",
  "metabolic review": "A metabolic and internal-medicine review for fatigue, insulin resistance, thyroid, weight drift, or prevention markers.",
  "sleep / recovery review": "A review focused on sleep quality, recovery capacity, and nervous-system regulation.",
  "glow token accrual": "Progress toward a future glow / LED / procedure-style benefit, usually tokenized or pack-gated.",
  "selective mini-check": "A light diagnostic check only when symptoms or overlay signals make it useful.",
  "metabolic-lite": "A light metabolic support layer for cravings, energy, meal timing, fiber, protein, or strength adherence.",
  "vitamin c": "Brightening and antioxidant routine support.",
  "niacinamide": "Barrier, tone, redness, and routine support.",
  "azelaic": "Pigment, redness, acne, and sensitive-skin compatible support where appropriate.",
  "ceramide": "Barrier repair and sensitive-skin support.",
  "underarm aha": "Body skin, texture, and underarm support.",
  "fiber mini": "Satiety, gut, metabolic-lite, and pantry support.",
  "protein mini": "Protein adequacy, cravings, strength, and GLP / metabolic support.",
  "foundational support": "The baseline supplement or recovery support matched to your month.",
  "foundational supplement pick": "The baseline supplement or recovery support matched to your month.",
  "daily foundation": "The baseline supplement or recovery support matched to your month.",
  "pantry / snack tool": "Food-structure support such as snack, broth, protein, fiber, or meal-prep help.",
  "pantry support": "Food-structure support such as snack, broth, protein, fiber, or meal-prep help.",
  "powder": "Protein, collagen, creatine, or fiber support depending on pathway.",
  "powder pick": "Protein, collagen, creatine, or fiber support depending on pathway.",
  "powder support": "Protein, collagen, creatine, or fiber support depending on pathway.",
  "nootropic": "Focus or calm-support option such as Citicoline, L-Theanine, Rhodiola, or Bacopa.",
  "nootropic pick": "Focus or calm-support option such as Citicoline, L-Theanine, Rhodiola, or Bacopa.",
  "focus support": "Focus or calm-support option such as Citicoline, L-Theanine, Rhodiola, or Bacopa.",
  "pulse stack": "Longevity pulse support such as NMN, Fisetin, and Quercetin where appropriate and tolerated.",
  "longevity pulse stack": "Longevity pulse support such as NMN, Fisetin, and Quercetin where appropriate and tolerated.",
  "visible vitality": "Skin, hair, glow, recovery, or barrier-support item.",
  "visible-vitality pick": "Skin, hair, glow, recovery, or barrier-support item.",
  "sticky perk": "A small retention benefit such as a friend pass, masterclass, partner demo, challenge, tonic bar, or workshop.",
  "gi-safe swap": "A gentler food or comfort swap for bloating, constipation, nausea, or flare-sensitive days.",
  "anti-inflammatory box": "A supportive box with items like omega-3, broths, ginger / turmeric-style support, or low-irritation pantry items.",
  "anti-inflammatory support": "A supportive box with items like omega-3, broths, ginger / turmeric-style support, or low-irritation pantry items.",
  "salicylic wash": "Body acne / acne-safe wash support.",
  "retinaldehyde": "Night routine / visible-vitality support where appropriate and not contraindicated.",
  "led booth": "Clinic LED or red-light session for skin recovery, glow, or visible vitality.",
  "clinic led / red-light": "Clinic LED or red-light session for skin recovery, glow, or visible vitality.",
  "biopeak-style recovery / red-light": "Clinic recovery or red-light session for visible vitality and recovery.",
  "biopeak intro": "Clinic recovery or red-light session for visible vitality and recovery.",
  "red-light": "Clinic LED or red-light session for skin recovery, glow, or visible vitality.",
  "acupuncture": "A complementary session for pain, stress, recovery, or nervous-system support.",
  "recovery coaching": "Coach-led recovery planning for sleep, stress, fatigue, or high-output weeks.",
  "recovery movement": "Gentle movement for pain, fatigue, or flare recovery days.",
  "pelvic-floor pt": "Pelvic-floor physiotherapy for core, pain, or function support.",
  "pelvic relaxation / breathwork": "A pelvic relaxation or breathwork session for pain, stress, or recovery.",
  "gentle pilates flow": "A gentle Pilates session for recovery, mobility, or low-energy days.",
  "flare day plan": "A structured plan for managing flare or high-symptom days.",
  "restorative yoga": "A restorative session for recovery, sleep, stress, or nervous-system support.",
  "restorative mobility": "A restorative mobility session for stiffness, recovery, or low-energy days.",
  "cooling workshop": "A cooling and sleep-reset workshop for temperature and night-waking issues.",
  "cooling / sleep reset workshop": "A cooling and sleep-reset workshop for temperature and night-waking issues.",
  "small-group strength": "A small-group strength session for energy, bone health, and metabolic support.",
  "clinic red-light": "Clinic LED or red-light session for skin recovery, glow, or visible vitality.",
  "movement-compliance": "Movement adherence support to keep your weekly rhythm consistent.",
  "aftercare workshop": "A post-procedure or post-treatment aftercare workshop.",
  "acne-safe routine": "A guided acne-safe skincare routine session.",
  "skin routine demo": "A guided skin routine demonstration for your current actives and products.",
  "spf": "Daily sun protection — the most important step for skin health and glow.",
  "ha": "Hyaluronic acid for hydration and barrier support.",
  "spf ↔ ha": "Daily sun protection or hyaluronic acid for hydration and barrier support.",
  "vitamin c ↔ niacinamide": "Brightening antioxidant or barrier / tone support — pick the one your skin needs most.",
  "azelaic ↔ ceramide": "Pigment and redness support or barrier repair — matched to your skin concern.",
  "underarm aha ↔ salicylic wash": "Body skin texture support or acne-safe wash — matched to your concern.",
  "fiber mini ↔ protein mini": "Satiety and gut support or protein adequacy — matched to your metabolic need.",
  "magnesium": "Sleep, muscle, and nervous-system support.",
  "magnesium ↔ electrolytes": "Sleep and muscle support or hydration and energy support.",
  "omega-3": "Anti-inflammatory and brain-health support.",
  "d3+k2": "Bone, immune, and mood support where appropriate.",
  "d3+k2 only if appropriate": "Bone, immune, and mood support — only included when clinically appropriate.",
  "sleep kit": "Sleep-support bundle for temperature, wind-down, and night-waking.",
  "sleep tea ↔ calming tea": "Sleep or calming tea support for wind-down and nervous-system comfort.",
  "collagen": "Skin, hair, joint, and recovery support.",
  "collagen ↔ ha-ceramide": "Collagen for recovery and glow or HA-ceramide for barrier and hydration.",
  "electrolyte": "Hydration and energy support.",
  "ha-ceramide": "Barrier repair and hydration support.",
  "broths": "Gut-soothing, anti-inflammatory, and comfort food support.",
  "heat patches": "Warmth and comfort for pain or flare days.",
  "warmth + comfort": "Warmth and comfort support for pain or flare days.",
  "ginger / peppermint support": "Digestive comfort and nausea support.",
  "ginger or peppermint tea": "Digestive comfort and nausea support.",
  "gi fiber support": "Gut fiber support for digestion and comfort — clinician-gated.",
  "iron support": "Iron support for energy and recovery — clinician-gated.",
  "full-size actives": "Full-size skincare actives — available through Derma Actives Pack.",
  "procedures": "Procedure access — available through milestone tokens.",
  "led mask": "At-home LED device for skin recovery and visible vitality — milestone unlock.",
  "dermashield+": "Advanced skin protection rider — preview only.",
  "metaborx": "Advanced metabolic prescription support — locked preview.",
  "advanced tests + devices": "Advanced diagnostics and devices — unlocked as your plan progresses.",
  "friend pod pass": "Invite a friend to join a pod session.",
  "masterclass": "Access to a premium masterclass or workshop.",
  "masterclass access": "Access to a premium masterclass or workshop.",
  "partner demo": "A partner brand demo or experience.",
  "step / stretch challenge": "A fun movement challenge for accountability and delight.",
  "challenge": "A fun movement or wellness challenge for accountability and delight.",
...
const keywordExplainers: [RegExp, string][] = [
  ...
  [/derm/i, "A skin-focused review for acne, pigmentation, barrier issues, glow, and procedure planning."],
  [/tricho/i, "A hair and scalp review for shedding, thinning, density, scalp irritation, or regrowth planning."],
  [/metabolic|internal medicine/i, "A metabolic and internal-medicine review for fatigue, insulin resistance, thyroid, weight drift, or prevention markers."],
  [/led|red-light/i, "Clinic LED or red-light session for skin recovery, glow, or visible vitality."],
  [/pod\b/i, "A guided group session tied to coaching."],
  [/pack\b/i, "An optional time-boxed boost, not required for core value."],
  [/rider|shield/i, "A future coverage add-on, not active day one."],
  [/ring/i, "A future wearable / device unlock."],
  [/cgm/i, "A glucose-monitoring window, usually milestone or pack-gated."],
  [/breathwork/i, "A nervous-system and recovery option for sleep, stress, fatigue, or high-output weeks."],
  [/strength|vo2/i, "A strength and aerobic-base support session for energy, performance, and longevity."],
  [/nootropic|citicoline|l-theanine|rhodiola|bacopa/i, "Focus or calm-support option such as Citicoline, L-Theanine, Rhodiola, or Bacopa."],
  [/collagen/i, "Skin, hair, joint, and recovery support."],
  [/magnesium/i, "Sleep, muscle, and nervous-system support."],
  [/omega/i, "Anti-inflammatory and brain-health support."],
  [/fiber/i, "Satiety, gut, metabolic-lite, and pantry support."],
  [/protein/i, "Protein adequacy, cravings, strength, and GLP / metabolic support."],
  [/glow|token/i, "Progress toward a future glow or procedure-style benefit."],
  [/pantry|broth|snack/i, "Food-structure support such as snack, broth, protein, fiber, or meal-prep help."],
  [/acupuncture/i, "A complementary session for pain, stress, recovery, or nervous-system support."],
  [/recovery/i, "A recovery-focused session for sleep, stress, fatigue, or high-output support."],
...
const explainOption = (name: string): string => {
  ...
  // Check alias map
  if (aliasExplainers[norm]) return aliasExplainers[norm];
  // Check optionExplainers case-insensitively
  for (const key of Object.keys(optionExplainers)) {
    if (normalizeOptionName(key) === norm) return optionExplainers[key];
  }
  // Keyword matching
  for (const [pattern, explanation] of keywordExplainers) {
    if (pattern.test(norm)) return explanation;
  }
