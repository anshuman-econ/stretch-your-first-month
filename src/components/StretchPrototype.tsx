...
const controlledSwapOptions = (pathway: Pathway, reason: string): ControlledSwap[] => {
  ...
  const details: Record<PathwayKey, Omit<ControlledSwap, "why">[]> = {
    peri: [
      { name: "Care route", current: "peri-aware women’s health review", includes: "Women’s health review, safe next steps, and protected labs when useful.", alternatives: ["internal medicine / metabolic review — if metabolic drift is selected", "skin-hair derm review — only if skin / hair support is selected"], change: "Your expert route changes. Diagnostics, prescriptions, riders, devices, and pathway identity stay protected.", action: "Swap care route" },
      { name: "Functional session", current: "cooling / sleep reset workshop or acupuncture or mobility", includes: "One body-support session matched to sleep, temperature, energy, or recovery.", alternatives: ["RDN", "mobility / physio", "Pilates / Barre", "acupuncture", "clinic LED / red-light", "recovery coaching"], change: "Your functional session changes, but your core care plan remains the same.", action: "Swap session" },
      { name: "Pods", current: "Peri Reset Pod + Sleep Reset Pod", includes: "Pod agenda, weekly prompts, and outputs for sleep, mood, energy, or symptoms.", alternatives: ["Mood / Fog Pod", "Metabolic Drift Pod", "Skin / Hair Pod", "Bone / Joint Pod"], change: "Your coaching plan and kit recommendations will adjust.", action: "Swap pod" },
      { name: "Experience pass", current: "cooling / sleep reset or breathwork", includes: "One monthly pass. Some red-light or strength options depend on availability.", alternatives: ["cooling workshop", "breathwork reset", "restorative mobility", "clinic red-light", "small-group strength"], change: "Your pass booking changes, but your care plan remains the same.", action: "Swap pass" },
      { name: "Kit item", current: "magnesium, omega-3, D3+K2 if indicated, sleep kit, collagen, electrolytes, HA-ceramide, pantry support", includes: "Sleep and recovery support, visible-vitality items, and pantry support where useful.", alternatives: ["magnesium ↔ electrolytes", "collagen ↔ HA-ceramide", "sleep tea ↔ calming tea", "D3+K2 only if appropriate"], change: "One kit item changes. Your coach plan and care route remain the same.", action: "Swap kit item" },
      { name: "Sticky perk", current: "Friend Pod Pass", includes: "A small motivation perk to help the month feel easier to complete.", alternatives: ["Friend Pod Pass", "Masterclass", "Partner Demo", "Step / Stretch Challenge"], change: "Your perk changes. Care, labs, pass, and pathway stay the same.", action: "Swap perk" },
    ],
    endo: [
