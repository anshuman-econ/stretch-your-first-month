...
function BuilderScreen({ pathway, onStart, onCoach }: { pathway: Pathway; onStart: () => void; onCoach: () => void }) {
  ...
  const stepCards = [
    ...
    { title: "2. Choose Pods", copy: "See the guided group sessions that help you practice the month.", block: planCards[2], action: "Review pods" },
    { title: "3. Build Kit", copy: "Check the at-home items Stretch selected for your pathway.", block: planCards[3], action: "Review kit" },
